...
const CommentsApiDoc = () => {
  return (
    <div className='p-4'>
      {/* Documentation for /api/comments */}
      <Card className='mb-8'>
        <CardHeader>
          <CardTitle>API Documentation: /api/comments</CardTitle>
        </CardHeader>
        <CardContent>
          <p className='mb-4'>
          ...
          <CodeBox title='/api/comments - GET'>
            {`
fetch('/api/comments', {
  method: 'GET',
  headers: {
  ...
  .catch(error => console.error('Error:', error));
          ...
          <CodeBox title='/api/comments - POST'>
            {`
fetch('/api/comments', {
  method: 'POST',
  headers: {
  ...
  .catch(error => console.error('Error:', error));
      ...
      {/* Documentation for /api/comments/:id */}
      <Card className='mb-8'>
        <CardHeader>
          <CardTitle>API Documentation: /api/comments/:id</CardTitle>
        </CardHeader>
        <CardContent>
          <p className='mb-4'>
          ...
          <CodeBox title='/api/comments/:id - GET'>
            {`
fetch('/api/comments/:id', {
  ...
  .catch(error => console.error('Error:', error));
          ...
          <CodeBox title='/api/comments/:id - PUT'>
            {`
fetch('/api/comments/:id', {
  method: 'PUT',
  headers: {
  ...
  .catch(error => console.error('Error:', error));
          ...
          <CodeBox title='/api/comments/:id - DELETE'>
            {`
fetch('/api/comments/:id', {
  method: 'DELETE',
  headers: {
